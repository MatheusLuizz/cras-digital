    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('professional', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='appointments_handled', to=settings.AUTH_USER_MODEL)),
